...
<body class="min-h-screen font-body-md relative overflow-y-auto select-none">
    ...
    <div class="min-h-screen w-full flex items-center justify-center py-6 md:py-10 relative z-10">
        <!-- Centered Glass Card -->
        <main class="w-full max-w-[420px] p-4 relative z-10">
            <div class="liquid-glass-card p-6 md:p-8">
                ...
                <div class="mb-4 relative z-10">
                    <h1 class="text-[28px] font-light text-white tracking-wide leading-tight mb-1 font-headline-sm">Masuk</h1>
                    <p class="text-white/60 text-xs font-light leading-relaxed">Selamat datang kembali. Silakan masuk ke akun Anda.</p>
                </div>
                ...
                <!-- Form -->
                <form action="{{ route('pelanggan.login.submit') }}" method="POST" class="space-y-4 relative z-10">
                    @csrf
                ...
                <footer class="mt-4 text-center text-xs text-white/50 relative z-10 font-light">
                    Belum punya akun? 
                    <a href="{{ route('pelanggan.register') }}" class="text-white hover:underline ml-1 font-medium transition-colors">Daftar Sekarang</a>
                </footer>
            </div>
        </main>
    </div>
