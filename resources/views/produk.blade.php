...
<head>
    ...
    <title>Koleksi Kami | XDrew Fashion</title>
...
<main class="relative z-10 pt-[120px] pb-20 min-h-screen px-margin-mobile md:px-margin-desktop w-full max-w-[1440px] mx-auto">
