    ...
    <div class="px-6 md:px-16 w-full max-w-[1440px] mx-auto relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16 mb-12">
            ...
            <div class="flex flex-col gap-5">
                <a href="{{ route('home') }}" class="font-headline-md text-2xl font-black tracking-widest text-[#1A2E26] hover:text-[#10b981] transition-colors duration-300">
                    XDREW <span class="text-[#10b981]">FASHION</span>
                </a>
                <p class="text-sm text-[#1A2E26]/70 leading-relaxed font-light mt-1">
            ...
            <div class="flex flex-col gap-4">
                <h4 class="font-headline-sm text-[#1A2E26] uppercase tracking-widest text-sm font-bold mb-4">Belanja</h4>
                <a class="text-sm text-[#1A2E26]/70 hover:text-[#10b981] hover:translate-x-1 transition-all duration-300 w-fit flex items-center gap-2 group" href="{{ route('produk.index') }}">
                    <span class="w-0 h-px bg-[#10b981] group-hover:w-3 transition-all duration-300"></span> Koleksi Terbaru
                </a>
                <a class="text-sm text-[#1A2E26]/70 hover:text-[#10b981] hover:translate-x-1 transition-all duration-300 w-fit flex items-center gap-2 group" href="{{ route('sustainability') ?? '#' }}">
                    <span class="w-0 h-px bg-[#10b981] group-hover:w-3 transition-all duration-300"></span> Keberlanjutan
                </a>
                <a class="text-sm text-[#1A2E26]/70 hover:text-[#10b981] hover:translate-x-1 transition-all duration-300 w-fit flex items-center gap-2 group" href="{{ route('jurnal') ?? '#' }}">
            ...
            <div class="flex flex-col gap-4">
                <h4 class="font-headline-sm text-[#1A2E26] uppercase tracking-widest text-sm font-bold mb-4">Dukungan</h4>
                <a class="text-sm text-[#1A2E26]/70 hover:text-[#10b981] hover:translate-x-1 transition-all duration-300 w-fit flex items-center gap-2 group" href="#">
        ...
        <div class="border-t border-[#1A2E26]/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 relative z-10">
            <p class="text-xs text-[#1A2E26]/70 font-light tracking-wide flex items-center gap-1">
                © {{ date('Y') }} XDrew Fashion. <span class="hidden md:inline">Consciously Crafted.</span>
            </p>
            <div class="flex gap-6 items-center">
                <span class="text-xs text-[#1A2E26]/70 font-light tracking-wide px-3 py-1 rounded-full border border-[#1A2E26]/10 bg-white/50 backdrop-blur-md">IDR (Rp)</span>
                <span class="text-xs text-[#1A2E26]/70 font-light tracking-wide px-3 py-1 rounded-full border border-[#1A2E26]/10 bg-white/50 backdrop-blur-md">Indonesia</span>
            </div>
        </div>
    </div>
</footer>