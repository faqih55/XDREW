...
<head>
    ...
    <title>Registrasi Admin | XDrew Fashion</title>
    ...
    <main class="w-full max-w-[420px] p-4 z-10">
        <div class="liquid-glass-card p-6 md:p-8">
            ...
            <div class="mb-4 relative z-10">
                <h1 class="text-[28px] font-light text-white tracking-wide leading-tight mb-1 font-headline-sm">Registrasi Admin</h1>
                <p class="text-white/60 text-xs font-light leading-relaxed">Buat akun Admin baru Anda.</p>
            </div>
            ...
            <!-- Form -->
            <form action="{{ route('admin.register.submit') }}" method="POST" class="space-y-4 relative z-10">
                @csrf
                
                <!-- Name Input -->
                <div class="relative">
                    <input type="text" name="nama_admin" id="nama_admin" value="{{ old('nama_admin') }}" required autofocus
            ...
            <footer class="mt-4 text-center text-xs text-white/50 relative z-10 font-light">
                Sudah punya akun? 
                <a href="{{ route('admin.login') }}" class="text-white hover:underline ml-1 font-medium transition-colors">Masuk</a>
            </footer>
        </div>
    </main>
