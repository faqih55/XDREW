...
<head>
    ...
    <title>Login Admin | XDrew Fashion</title>
...
<body class="min-h-screen flex items-center justify-center font-body-md relative overflow-y-auto select-none py-6 md:py-10">
    ...
    <main class="w-full max-w-[420px] p-4 z-10">
        <div class="liquid-glass-card p-6 md:p-8">
            ...
            <div class="mb-4 relative z-10">
                <h1 class="text-[28px] font-light text-white tracking-wide leading-tight mb-1 font-headline-sm">Masuk Admin</h1>
                <p class="text-white/60 text-xs font-light leading-relaxed">Selamat datang kembali, Admin.</p>
            </div>
            ...
            @endif
            @if (session('success'))
                <div class="mb-4 p-3 rounded-2xl bg-green-500/10 border border-green-500/20 text-green-200 text-xs relative z-10 backdrop-blur-md">
                    {{ session('success') }}
                </div>
            @endif

            <!-- Form -->
            <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-4 relative z-10">
                @csrf
                ...
                <div class="flex items-center justify-between text-xs text-white/70 pt-1">
                    <label class="flex items-center space-x-2.5 cursor-pointer">
                        <input type="checkbox" name="remember" id="remember" class="glass-checkbox w-4 h-4 text-white/30 focus:ring-0">
                        <span class="font-light">Ingat saya</span>
                    </label>
                    <a href="#" class="hover:text-white hover:underline transition-colors font-light">Lupa Kata Sandi?</a>
                </div>
            ...
            <div class="flex justify-center gap-3 mb-4 relative z-10">
                <!-- Google -->
                <a href="#" class="glass-social-btn hover:border-red-500/35 hover:bg-red-500/5 group" title="Masuk dengan Google">
                ...
                <!-- Facebook -->
                <a href="#" class="glass-social-btn hover:border-[#1877F2]/35 hover:bg-[#1877F2]/5 group" title="Masuk dengan Facebook">
                ...
                <!-- Apple -->
                <a href="#" class="glass-social-btn hover:border-white/35 hover:bg-white/5 group" title="Masuk dengan Apple">
                ...
                <!-- Twitter (X) -->
                <a href="#" class="glass-social-btn hover:border-white/35 hover:bg-white/5 group" title="Masuk dengan Twitter">
                    <svg viewBox="0 0 24 24" class="w-[18px] h-[18px] flex-shrink-0 transition-transform group-hover:scale-110" fill="#FFFFFF">
            ...
            <footer class="mt-4 text-center text-xs text-white/50 relative z-10 font-light">
                ...
                <a href="{{ route('admin.register') }}" class="text-white hover:underline ml-1 font-medium transition-colors">Daftar Sekarang</a>
            </footer>
        </div>
    </main>
