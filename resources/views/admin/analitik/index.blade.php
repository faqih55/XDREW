...
<div class="p-4 md:p-8">
    <header class="flex flex-col justify-start gap-2 mb-8 border-b border-black/5 pb-6">
        <h2 class="text-3xl font-extrabold text-[#1A2E26] tracking-tight uppercase">Analitik <span class="text-[#10b981]">Bisnis.</span></h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 glass-card rounded-3xl p-6 border-t-2 border-t-[#10b981] shadow-lg">
            <h3 class="font-bold text-[#1A2E26] uppercase tracking-widest text-xs mb-6">Grafik Penjualan Tahun Ini</h3>
        ...
        <div class="glass-card rounded-3xl p-6 space-y-6 shadow-lg">
            <h3 class="font-bold text-[#1A2E26] uppercase tracking-widest text-xs mb-4">Statistik Singkat</h3>
            ...
            <div class="p-4 bg-white/50 rounded-xl border border-black/5 hover:border-[#10b981]/30 transition-colors">
                ...
                <p class="font-bold text-[#1A2E26] text-lg">{{ number_format($total_pesanan) }} Pesanan</p>
            </div>
            <div class="p-4 bg-white/50 rounded-xl border border-black/5 hover:border-[#10b981]/30 transition-colors">
                <p class="text-[10px] text-slate-400 uppercase tracking-widest mb-1">Total Pelanggan</p>
                <p class="font-bold text-[#1A2E26] text-lg">{{ number_format($total_pelanggan) }} Orang</p>
            </div>
            <div class="p-4 bg-white/50 rounded-xl border border-black/5 hover:border-[#10b981]/30 transition-colors">
