...
<body class="bg-[#F9FAFB] text-[#0A1612] font-body-md selection:bg-emerald-100 relative">
    ...
    <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div class="absolute left-[-10%] top-[20%] w-[500px] h-[500px] rounded-full bg-[#6ffbbe] blur-[150px] opacity-40 " ></div>
        <div class="absolute right-[-10%] top-[40%] w-[600px] h-[600px] rounded-full bg-[#4edea3] blur-[180px] opacity-25" ></div>
        <div class="absolute left-[30%] bottom-[-10%] w-[400px] h-[400px] rounded-full bg-[#3bd58f] blur-[130px] opacity-35 "  style="animation-delay: 1.5s;"></div>
    </div>
