...
<div class="max-w-5xl mx-auto space-y-8 animate-smooth-reveal">
    <header class="mb-8 flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
            <h1 class="font-['Outfit'] text-3xl font-extrabold text-[#1A2E26] mb-2 tracking-tight">Keamanan Akun</h1>
            <p class="text-[#1A2E26]/70 text-sm">Ubah kata sandi Anda untuk menjaga keamanan akun Anda.</p>
        </div>
    ...
    <div class="bg-white/40 backdrop-blur-md rounded-[2rem] p-8 border border-white/60 shadow-lg relative overflow-hidden">
        ...
        <form action="{{ route('profile.keamanan.update') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2 group">
                <label for="current_password" class="block text-sm font-bold text-[#1A2E26]/70 group-focus-within:text-[#10b981] transition-colors">Kata Sandi Saat Ini</label>
            ...
            <!-- Password Baru -->
            <div class="space-y-2 group">
                <label for="password" class="block text-sm font-bold text-[#1A2E26]/70 group-focus-within:text-[#10b981] transition-colors">Kata Sandi Baru</label>
            ...
            <div class="space-y-2 group">
                <label for="password_confirmation" class="block text-sm font-bold text-[#1A2E26]/70 group-focus-within:text-[#10b981] transition-colors">Konfirmasi Kata Sandi Baru</label>
